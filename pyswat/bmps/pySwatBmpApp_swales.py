...
env = r'C:\Default_7.gdb'
Swales = r'C:\Default_7.gdb\swales_95_teste_todo'
boundaries = r'C:\Default_7.gdb\lotes_basin_swat_clip'
output_feature_class = r'\swales_95_mirrored'
mirror(Swales,boundaries, output_feature_class, env)

#Commands for matchsize App
########################################################################
mirrored_swales = r'C:\Default_7.gdb\swales_95_mirrored'
output_feature_class_enlarged = r'\swales_95_mirrored_enlarged'
