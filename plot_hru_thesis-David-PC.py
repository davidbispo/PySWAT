...
##########################             
def plotflowout(folder, dic, outname):
    ...
    for i in dicarrays:
        ...
        plt.xticks(dates_list, rotation=50, fontsize=12)
        plt.yticks(fontsize=14)
        plt.xlim(startdate,enddate)
        plt.grid()
        plt.title(dic[val][1], fontsize=20)
        plt.legend(loc='best', ncol=2)
        #plt.xaxis.major_formatter(xfmt)
        plt.ylabel(r'Reach Flow(FLOW_OUT_cms) - $m^3/s$', size=15)
...
bio_flowout= r'E:\OneDrive\swat_results\biorretention_flow_out'
inf_flowout= r'E:\OneDrive\swat_results\InfBasins_flow_out'
swa_flowout= r'E:\OneDrive\swat_results\swales_flow_out'

dic_inf_flw = {
        'altered_10-InfBasins99.csv' : ['InfBasins - Altered', 'Infiltration basins - SQ Station'],
        'altered_30-InfBasins99.csv' : ['InfBasins - Altered', 'Infiltration basins - SQ Station'],
        'altered_50-InfBasins99.csv' : ['InfBasins - Altered', 'Infiltration basins - SQ Station'],
        'altered_70-InfBasins99.csv': ['InfBasins - Altered', 'Infiltration basins - SQ Station'],
        'calibrated-InfBasins99.csv': ['InfBasins - Altered', 'Infiltration basins - SQ Station'],
        
        'altered_10-InfBasins155.csv' : ['InfBasins - Altered', 'Infiltration basinns - CX Station'],
        'altered_30-InfBasins155.csv' : ['InfBasins - Altered', 'Infiltration basins - CX Station'],
        'altered_50-InfBasins155.csv' : ['InfBasins - Altered', 'Infiltration basins - CX Station'],
        'altered_70-InfBasins155.csv': ['InfBasins - Altered', 'Infiltration basins - CX Station'],
        'calibrated-InfBasins155.csv': ['InfBasins - Altered', 'Infiltration basins - CX Station'],
        }

dic_swa_flw = {
        'altered_10-swales98.csv' : ['Swales - Altered', 'Swales - SQ Station'],
        'altered_30-swales98.csv' : ['Swales - Altered', 'Swales - SQ Station'],
        'altered_50-swales98.csv' : ['Swales - Altered', 'Swales - SQ Station'],
        'altered_70-swales98.csv': ['Swales - Altered', 'Swales - SQ Station'],
        'calibrated-swales98.csv': ['Swales - Altered', 'Swales - SQ Station'],
        
        'altered_10-swales155.csv' : ['Swales - Altered', 'Swales - CX Station'],
        'altered_30-swales155.csv' : ['Swales - Altered', 'Swales - CX Station'],
        'altered_50-swales155.csv' : ['Swales - Altered', 'Swales - CX Station'],
        'altered_70-swales155.csv': ['Swales - Altered', 'Swales - CX Station'],
        'calibrated-swales155.csv': ['Swales - Altered', 'Swales - CX Station'],
        
        }

dic_bio_flw = {
        'altered_10-biorretention99.csv' : ['Biorretention - Altered', 'Biorretention - SQ Station'],
        'altered_30-biorretention99.csv' : ['Biorretention - Altered', 'Biorretention - SQ Station'],
        'altered_50-biorretention99.csv' : ['Biorretention - Altered', 'Biorretention - SQ Station'],
        'altered_70-biorretention99.csv': ['Biorretention - Altered', 'Biorretention - SQ Station'],
        'calibrated-biorretention99.csv': ['Biorretention - Altered', 'Biorretention - SQ Station'],
        
        'altered_10-biorretention155.csv' : ['Biorretention - Altered', 'Biorretention - CX Station'],
        'altered_30-biorretention155.csv' : ['Biorretention - Altered', 'Biorretention - CX Station'],
        'altered_50-biorretention155.csv' : ['Biorretention - Altered', 'Biorretention - CX Station'],
        'altered_70-biorretention155.csv': ['Biorretention - Altered', 'Biorretention - CX Station'],
        'calibrated-biorretention155.csv': ['Biorretention - Altered', 'Biorretention - CX Station'],
        }

plotflowout(bio_flowout, dic= dic_bio_flw, outname = "Biorretention")

plotflowout(swa_flowout, dic= dic_swa_flw, outname = "Swales")

plotflowout(inf_flowout, dic= dic_inf_flw, outname = "Inf. Basins")
