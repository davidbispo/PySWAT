...
def read_output_rch(fileadress, filetype, list_lkp, rch):
...
def compare_efficiency(array_sim,array_obs):
    
        
adress_out = r'D:\OneDrive\output.rch'
array_output = read_output_rch(adress_out, filetype = 'rch', list_lkp=["FLOW_OUTcms"], rch = 39)
array_obs = read_observed(fileadress)
output_printer(array_output)   