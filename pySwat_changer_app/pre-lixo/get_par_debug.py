...
input_folder = r'C:\Users\david\Desktop\Default_test_python\TxtInOut'
instance = swat_table(TXTInOut = input_folder, sb = [1,3,5,8], lulc=['CMPO','VARN'])
