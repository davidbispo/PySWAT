...
#TXTInOut = r'C:\Barigui_swales\Scenarios\Calibrated\TxtInOut'
TXTInOut = r'C:\Barigui_swales\Scenarios\Altered\TxtInOut'
...
instance_cp.change(parameter = 'CH_N1', method = 'relative', value =-0.0138  , sb= list(range(1,40)))#14
...
instance_cp.change(parameter = 'CH_K2', method = 'replace', value = 373.520, sb= list(range(1,40)))#9 
...
instance_cp.change(parameter = 'CN2', method = 'relative', value = 0.0364, sb= list(range(100,156)))#1
instance_cp.change(parameter = 'ALPHA_BF', method = 'replace', value = 1.013, sb= list(range(100,156)))#1
instance_cp.change(parameter = 'GWQMN', method = 'replace', value = 4178.194, sb= list(range(100,156)))#20
instance_cp.change(parameter = 'RCHRG_DP', method = 'replace', value = 0.943, sb= list(range(100,156)))#21
instance_cp.change(parameter = 'HRU_SLP', method = 'relative', value = -0.188, sb= list(range(100,156)))#4
instance_cp.change(parameter = 'LAT_TTIME', method = 'replace', value = 14.481, sb= list(range(100,156)))#13
instance_cp.change(parameter = 'CH_N1', method = 'relative', value =  0.134, sb= list(range(100,156)))#14
instance_cp.change(parameter = 'CH_N2', method = 'relative', value = -0.0346, sb= list(range(100,156)))#232
instance_cp.change(parameter = 'ALPHA_BNK', method = 'replace', value = 0.654, sb= list(range(100,156)))#24
instance_cp.change(parameter = 'CH_K2', method = 'replace', value = 175.229, sb= list(range(100,156)))#25
"""


"""
os.chdir(r'E:\Barigui_swales\TxtInOut')       
print("Running Swat..")
...
output_sims = r'E:\sim_result.txt'
...
"""
#instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.083233, sb= 'all', lulc ='SWRD')
#instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.083233, sb= 'all', lulc ='SWID')


print('changing parameters on swales...')
instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.7, sb= 'all', lulc ='SWRE')
instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.7, sb= 'all', lulc ='SWIN')
