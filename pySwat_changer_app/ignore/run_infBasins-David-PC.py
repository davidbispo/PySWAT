...
#TXTInOut = r'C:\Barigui_InfBasins\Scenarios\Calibrated\TxtInOut'
TXTInOut = r'C:\Barigui_InfBasins\Scenarios\Altered\TxtInOut'
...
print('changing parameters on Infiltration Basins...')

instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.7, sb= 'all', lulc ='IBRE')
instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.7, sb= 'all', lulc ='IBIN')

"""
#instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.95, sb= 'all', lulc ='all')
#instance_cp.change(parameter = 'CN2', method = 'relative', value = -0.95, sb= 'all', lulc ='all')
