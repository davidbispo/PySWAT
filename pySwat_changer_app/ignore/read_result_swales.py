...
output_simlog = r'E:\sim_result.txt'

TXTInOut = r'E:\Barigui_swales\TxtInOut'
...
instance_output_simarray.print_allinone(r'E:\results_swales.png', figsize = (25.7,17), xlim =(1000,1020))